            ...
            <ul className="navbar-nav">
                <li className="logo">
                    <a href="/#" className="nav-link">
                        <span className="link-text logo-text">Signal</span>
                        <svg
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fad"
                ...
                <li className="nav-item">
                    <a href="/#" className="nav-link">
                        <svg className={"svg"} fill="none" height="31" viewBox="0 0 20 20" width="31" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <li className="nav-item">
                    <a href="/#" className="nav-link">
                        <svg className={"svg"} width="31" height="31" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="nav-item" id="themeButton">
                    <a href="/#" className="nav-link">
                        <svg className={"svg"} fill="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="31px"
                             height="31px">
                            <path
